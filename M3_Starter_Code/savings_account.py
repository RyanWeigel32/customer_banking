...
def create_savings_account( balance, interest, months):
    ...
    user_account = Account(balance, interest, months)

    # Calculate interest earned
    interest_earned = balance * interest * months

    # Update the savings account balance by adding the interest earned
    updated_savings_balance = user_account.balance + interest_earned

    # Pass the updated_balance to the set balance method using the instance of the SavingsAccount class.
    user_account.set_balance(updated_savings_balance)
